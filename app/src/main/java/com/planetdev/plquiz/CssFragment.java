...
public class CssFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAnswer = mCssQuestionLibrary.getAnswer(mNextQuestion);
    ...
    public void updateQuestions (){
        mQuestionView.setText(mCssQuestionLibrary.getQuestion(mNextQuestion));
        mChoice0.setText(mCssQuestionLibrary.getChoice0(mNextQuestion));
        mChoice1.setText(mCssQuestionLibrary.getChoice1(mNextQuestion));
        mChoice2.setText(mCssQuestionLibrary.getChoice2(mNextQuestion));
    }
    ...
    public void onAnyButtonClicked(){
        ...
        mQuestionNumber.setText(mQuestionCount[0] + " of " + mCssQuestionLibrary.mQuestions.length);
        ...
        mContinueButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(mQuestionCount.length+1 == mCssQuestionLibrary.mQuestions.length ){
                    mQuestionNumber.setText(mCssQuestionLibrary.mQuestions.length + " of " + mCssQuestionLibrary.mQuestions.length);

                }else if(mQuestionCount[0] == mCssQuestionLibrary.mQuestions.length ){
                    mQuestionNumber.setText(mCssQuestionLibrary.mQuestions.length + " of " + mCssQuestionLibrary.mQuestions.length);
                ...
                if (mNextQuestion < mCssQuestionLibrary.getQuestion(mNextQuestion).length()-1){
                    mNextQuestion++;
                }
        ...
        mSubmit.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                TotalScore = (mScore * 100) / mCssQuestionLibrary.mQuestions.length;
